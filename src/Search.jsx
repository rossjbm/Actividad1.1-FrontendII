    ...
    return (<>
        <div className="w-3/5 p-4 flex justify-around gap-2 my-16 mx-auto bg-beige-100 rounded-xl shadow-xl">
            ...
            <div className=" w-1/5 flex justify-center">
                <button className="hover:bg-beige-200 px-3 m-0 h-full w-full"><span style={{fontSize:"2.5em"}} class="material-symbols-outlined">tune</span></button>
                <button  className="hover:bg-beige-200 border-l border-beige-800 m-0 px-3 w-full h-full"><span style={{fontSize:"2.5em"}} class="material-symbols-outlined">add</span></button>
            </div>
        </div>
